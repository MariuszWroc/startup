...
CREATE TABLE IF NOT EXISTS `hackandslash`.`GameCharacter` (
  ...
  `experienceOnLevel` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hackandslash`.`Item` (
  ...
  `timeOfWorking` INT(11) NULL DEFAULT 0,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
START TRANSACTION;
USE `hackandslash`;
INSERT INTO `hackandslash`.`GameCharacter` (`id`, `firstname`, `lastname`, `gender`, `age`, `race`, `profession`, `strength`, `dexterity`, `constitution`, `intelligence`, `baseHP`, `currentHP`, `baseAC`, `effectiveAC`, `experienceOnLevel`, `actualLevel`) VALUES (1, 'Mariusz', 'Braveheart', 1, 27, 1, 3, 12, 16, 16, 12, 10, 10, 5, 5, 1, 1);
INSERT INTO `hackandslash`.`GameCharacter` (`id`, `firstname`, `lastname`, `gender`, `age`, `race`, `profession`, `strength`, `dexterity`, `constitution`, `intelligence`, `baseHP`, `currentHP`, `baseAC`, `effectiveAC`, `experienceOnLevel`, `actualLevel`) VALUES (2, 'Ork', 'Warrior', 1, NULL, 3, 2, 12, 10, 14, 2, 8, 8, 3, 3, 1, 1);
INSERT INTO `hackandslash`.`GameCharacter` (`id`, `firstname`, `lastname`, `gender`, `age`, `race`, `profession`, `strength`, `dexterity`, `constitution`, `intelligence`, `baseHP`, `currentHP`, `baseAC`, `effectiveAC`, `experienceOnLevel`, `actualLevel`) VALUES (3, 'Villager', NULL, 1, NULL, 1, 0, NULL, NULL, NULL, NULL, 1, 1, 1, 1, 1, 1);
INSERT INTO `hackandslash`.`GameCharacter` (`id`, `firstname`, `lastname`, `gender`, `age`, `race`, `profession`, `strength`, `dexterity`, `constitution`, `intelligence`, `baseHP`, `currentHP`, `baseAC`, `effectiveAC`, `experienceOnLevel`, `actualLevel`) VALUES (4, 'Jacek', NULL, 1, 26, 1, 3, 14, 16, 15, 12, 10, 10, 4, 4, 1, 1);
INSERT INTO `hackandslash`.`GameCharacter` (`id`, `firstname`, `lastname`, `gender`, `age`, `race`, `profession`, `strength`, `dexterity`, `constitution`, `intelligence`, `baseHP`, `currentHP`, `baseAC`, `effectiveAC`, `experienceOnLevel`, `actualLevel`) VALUES (5, 'Jacek2', NULL, 1, 26, 1, 3, 14, 16, 15, 12, 10, 10, 3, 3, 1000, 1);
...
START TRANSACTION;
USE `hackandslash`;
INSERT INTO `hackandslash`.`Item` (`id`, `name`, `category`, `wage`, `attack`, `defend`, `magic`, `addHealth`, `addStrength`, `addDexterity`, `addConstitution`, `addIntelligence`, `amount`) VALUES (1, 'Long Sword', 2, 5, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10);
